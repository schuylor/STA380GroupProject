...
The authors used Gemini and ChatGPT for: 
 -technical troubleshooting/debugging R error messages and  Git version control conflicts.
 -Helping to generate ideas for test cases
 -Providing R grammar suggestions and feedback on formatting
The authors reviewed and verified any AI-suggested logic and feedback 
